    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('hourly_price_currency', djmoney.models.fields.CurrencyField(choices=[('INR', 'Indian Rupee'), ('USD', 'US Dollar')], default='INR', editable=False, max_length=3)),
                ('hourly_price', djmoney.models.fields.MoneyField(decimal_places=0, max_digits=10)),
                ('monthly_price_currency', djmoney.models.fields.CurrencyField(choices=[('INR', 'Indian Rupee'), ('USD', 'US Dollar')], default='INR', editable=False, max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_currency', djmoney.models.fields.CurrencyField(choices=[('INR', 'Indian Rupee'), ('USD', 'US Dollar')], default='INR', editable=False, max_length=3)),
                ('tax', djmoney.models.fields.MoneyField(blank=True, decimal_places=0, default=None, max_digits=10, null=True)),
                ('total_currency', djmoney.models.fields.CurrencyField(choices=[('INR', 'Indian Rupee'), ('USD', 'US Dollar')], default='INR', editable=False, max_length=3)),
